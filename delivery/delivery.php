...
if (isset($_POST['action']) && isset($_POST['order_id'])) {
    ...
    $q = "SELECT email FROM delivery_persons WHERE Did='$did'";
    $res = mysqli_query($connection, $q);
    $row = mysqli_fetch_assoc($res);

    $delivery_email = $row['email'];

    if ($action == 'accept') if ($action == 'accept') {

    $donor_otp = rand(100000,999999);
    $ngo_otp = rand(100000,999999);
    ...
    try{
        ...
        $mail->Subject = 'Food Pickup OTP';

        $mail->Body =
'Your Pickup OTP is: '.$donor_otp.
"\n\nGive this OTP to the delivery person when the food is collected.";
    ...
    try{
        ...
        $mail->Subject = 'Food Delivery OTP';

        $mail->Body =
'Your Delivery OTP is: '.$ngo_otp.
"\n\nGive this OTP to the delivery person when the food is delivered.";
